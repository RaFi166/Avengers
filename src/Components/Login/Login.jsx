            ...
            <div className="bg-white shadow-xl shadow-2xl rounded shadow-xl mb-32 rounded-2xl  text-center mt-20 p-10 w-2/5 mx-auto">
                <div>
                    ...
                    <form className="border-t-2 pt-2">
                        <input onBlur={getEmail} className="mb-5 w-2/3 border-2 border-black rounded w-80" placeholder="Enter Email" required type="text" /> <br />
                        <input onBlur={getPassword} className=" w-2/3 rounded border-2 border-black" placeholder="Enter Password" required type="password" /> <br />
